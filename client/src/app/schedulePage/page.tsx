...
export default function CulturalAgendaPage() {
  ...
  const filteredEvents = mockEvents.filter(event => {
    ...
    const matchCategory = categoryFilter === 'Todas' || event.category === categoryFilter;
    ...
    <div className="min-h-screen bg-gray-50 font-sans pb-20">
      ...
      <header className="bg-linear-to-r from-blue-600 to-blue-500 pt-12 pb-24 px-6 shadow-lg">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-2 mb-4 text-blue-100/90">
             <CalendarDays className="w-5 h-5" />
             <span className="text-xs font-bold tracking-widest uppercase">Agenda Cultural</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">
            Descubra eventos culturais do Recife
          </h1>
          <p className="text-blue-50 text-lg max-w-2xl font-light">
            Explore shows, exposições, cinema e muito mais acontecendo na sua cidade.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-12 relative z-10">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-10">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1">
              <label htmlFor="gratuidade" className="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wide">
                Gratuidade:
              </label>
            ...
            <div className="flex-1">
              <label htmlFor="categoria" className="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wide">
                Categoria:
              </label>
              <div className="relative group">
                 <select
        ...
        {filteredEvents.length > 0 ? (
          ...
          <div className="text-center py-24 bg-white rounded-2xl border border-dashed border-gray-200 shadow-sm">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">Nenhum evento encontrado</h3>
            <p className="text-gray-500 mb-6">Tente selecionar outra categoria ou gratuidade.</p>
            <button 
              onClick={() => {setCategoryFilter("Todas"); setFreeFilter("Todas")}}
