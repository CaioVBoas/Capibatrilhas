...
const SummaryCard: React.FC<SummaryCardProps> = ({ challengesSelected, totalReward, remainingCapibas }) => {
  return (
    ...
    <div className={`${dmSans.className} bg-linear-to-r from-blue-100 to-orange-100 rounded-xl shadow-sm border border-gray-200 p-8 
      ...
      <div className="relative z-10 grid grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-white/40 rounded-lg backdrop-blur-sm">
          <p className={`text-gray-600 text-sm font-medium mb-2 ${outfit.className}`}>Desafios Selecionados</p>
          <span className="text-4xl font-bold text-gray-900">{challengesSelected}</span>
        </div>

        {/* Recompensa Total */}
        <div className="flex flex-col items-center justify-center p-4 bg-white/40 rounded-lg backdrop-blur-sm">
          <p className={`text-gray-600 text-sm font-medium mb-2 ${outfit.className}`}>Recompensa Total</p>
        ...
        {/* Capibas Restantes */}
        <div className="flex flex-col items-center justify-center p-4 bg-white/40 rounded-lg backdrop-blur-sm">
          <p className={`text-gray-600 text-sm font-medium mb-2 ${outfit.className}`}>Capibas Restantes</p>
